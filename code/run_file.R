...
# financials can be pretty easily pulled from the urban institute education data portal.
# Documentation is here:https://educationdata.urban.org/documentation/#r
